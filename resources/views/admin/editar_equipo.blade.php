			...
			<div class="row">
				<div class="col-md-3">
					...
					<select class="form-control" name="marca">
						  ...
						  <option @if($equipo->marca == 'Practica') {{ 'selected' }} @endif value="Practica">Practica</option>
						  <option @if($equipo->marca == 'Plantronics') {{ 'selected' }} @endif value="Plantronics">Plantronics</option>
					</select>
				</div>
				<div class="col-md-3">
