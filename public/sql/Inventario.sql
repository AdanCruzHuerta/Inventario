...
CREATE TABLE `departamento_has_impresora` (
  ...
  CONSTRAINT `fk_departamento_has_impresora_departamento1` FOREIGN KEY (`departamento_id`) REFERENCES `departamento` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_departamento_has_impresora_impresora1` FOREIGN KEY (`impresora_id`) REFERENCES `impresora` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `impresora` VALUES (1,'Lexmark','Lexmark','LXM100','GSTYYTABSJ','','Cualquier cosa','7','Inyección de Tinta','2016-07-08 00:00:00','2016-06-28 00:00:00','2016-07-08 00:00:00');
...
INSERT INTO `usuarios` VALUES (1,'christian1350@hotmail.com','$2y$10$kD9/0UQIOphwTw5g3GbHRunTmcsrF061rigp3R5XZEePi33U2ZxjO','2016-07-02 14:43:18','2016-07-02 15:01:44','7i2POf9mNQ2oKSwy03LlXlCIoLg3yNhSlzwvedwn1CWf9d3e6nr26vCu4nMT');
...
-- Dump completed on 2016-07-03 13:27:55
